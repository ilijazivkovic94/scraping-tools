        ...
        .then(async function (browser) {
          try {
            ...
            let images = await page.evaluate(() => {
              ...
              let useSrcset = false;
              if (
                window.location.href.indexOf("chewy.com") > -1 ||
                window.location.href.indexOf("cvs.com") > -1
              ) {
              ...
              if (window.location.href.indexOf("samsclub.com") > -1) {
                imageTags = document.querySelectorAll(
                  ".sc-pc-large-desktop-layout-columns img"
                );
              }
              ...
              if (window.location.href.indexOf("therealreal.com") > -1) {
                imageTags = document.querySelectorAll(
                  ".pdp-desktop-images img"
                );
                httpOnly = true;
              }
              if (window.location.href.indexOf("westelm.com") > -1) {
                imageTags = document.querySelectorAll(
                  "#pip-hero-container-WE img"
                );
                httpOnly = true;
              }
              ...
              if (window.location.href.indexOf("shop.lululemon.com") > -1) {
                imageTags = document.querySelectorAll(
                  ".pdp-carousel-images-offset img"
                );
                limitHeight = 70;
                limitWidth = 70;
                removeQuery = true;
              ...
              if (window.location.href.indexOf("bedbathandbeyond.com") > -1) {
                const shadowInside =
                  document.querySelector("#wmHostPdp").shadowRoot;
              ...
              for (let i = 0; i < imageTags.length; i++) {
                ...
                if (
                  !useSrcset &&
                  imageElement.naturalHeight >= limitHeight &&
                  imageElement.naturalWidth >= limitWidth &&
                  imageElement.style.display != "none" &&
                  bBox.y < 2000 &&
                  imageElement.src.indexOf("/flags/") === -1 &&
                  imageElement.src
                ) {
                  if (httpOnly) {
                    if (
                      imageElement.src.indexOf("http") > -1 &&
                      imageElement.src.indexOf("http") != 0
                    ) {
                      continue;
                    } else {
                  ...
                  if (
                    imageElement.naturalHeight > 400 &&
                    bBox.y < 600 &&
                    bBox.y > 80 &&
                    !mainImage &&
                    imageElement.src.indexOf("null") < 0
                  ) {
                    if (removeQuery) {
              ...
              if (!result.length || useSrcset) {
                for (let i = 0; i < imageTags.length; i++) {
                  ...
                  if (imageElement.srcset) {
                    if (
                      window.location.href.indexOf("shop.lululemon.com") > -1
                    ) {
